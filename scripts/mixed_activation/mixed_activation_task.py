...
import re, os
import argparse
from performance_simulator_mixed_act import *
...
def main():
    ...
    df = calc_m4bram_mixed_act_performance(network=nn_name, mode=m4bram_mode, variant=m4bram_variant,
    ...
    with open(file_path, 'a') as f:
        f.write(nn_name.ljust(10) + str(mode+'-'+variant).ljust(15) + str(str(weight_precision)+'-bit').ljust(8) + \
